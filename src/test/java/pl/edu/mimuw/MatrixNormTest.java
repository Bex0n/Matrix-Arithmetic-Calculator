...
public class MatrixNormTest {
  ...
  public class FrobeniusNormTest {
    ...
    @Test
    void testRow() {
      final var m = row(matrix(4, 4), 4, 3, 0, 0);
      assert m.frobeniusNorm() == 10;
    }
    
    @Test
    void testColumn() {
      final var m = column(matrix(4,4), 4, 3, 0, 0);
      assert m.frobeniusNorm() == 10;
    }
    
    @Test
    void testConstant() {
      final var m = constant(matrix(5,5), 5);
      assert m.frobeniusNorm() == 25;
    }
  }
  ...
  public class NormInfinityTest {
    ...
    void testRow() {
      final var m = row(matrix(4, 4), 4, 3, 0, 0);
      assert m.normInfinity() == 16;
    }
    
    @Test
    void testColumn() {
      final var m = column(matrix(4,4), 4, 3, 0, 0);
      assert m.normInfinity() == 7;
    }
    
    @Test
    void testConstant() {
      final var m = constant(matrix(5,5), 5);
      assert m.normInfinity() == 25;
    }
  }
